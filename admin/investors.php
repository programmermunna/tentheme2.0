                ...
                <div class="overflow-auto bg-white">
                  <div style="display:flex;justify-content:space-between">
                    <div style="display:flex">
                      <a style="margin:15px;display:block;text-align:center;padding-top:12px;" class="input" href="investors.php">Refresh <i  class="fa-solid fa-rotate-right"></i></a>
                    </div>
                  ...
                  <form action="" method="POST">
                    <div class="top_link">
                      ...
                      <a href="investors.php?investor=Submitted">Submitted (<?php echo $submitted_resseler?>)</a> |
                      <a href="investors.php?investor=Accepted">Accepted (<?php echo $accepted_resseler?>)</a> |
                      <a href="investors.php?investor=Rejected">Rejected (<?php echo $rejected_resseler?>)</a> |
                      <input type="submit" name="check" value="Reject Now">
                    </div>
                    <!-- Table -->
