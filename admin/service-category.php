                ...
                <div class="overflow-auto bg-white">
                  <div style="display:flex;justify-content:space-between">
                    <div style="display:flex">
                      <a style="margin:15px;display:block;text-align:center;padding-top:12px;" class="input" href="service-category.php">Refresh <i  class="fa-solid fa-rotate-right"></i></a>
                    </div>
                    ...
                    <div>
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if(!empty($category)){
                          $insert = _insert("category","category,type,time","'$category','Service',$time");
                          if($insert){
                            $msg = "Successfully Insert Category";
                            header("location:service-category.php?msg=$msg");
                          }
                        }else{
                          $err = "Please Write Category Name";
                          header("location:service-category.php?err=$err");
                        }
                      }
                      ?>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    $category =_query("SELECT * FROM category WHERE type='Service' ORDER BY id DESC LIMIT $offset, $total_records_per_page");
                    $total_records = mysqli_num_rows(_get("category","type='Service'")); 
                    ...
                    ?>
                      <tr class="hover:bg-gray-100">
                        ...
                        <td class="text-center p-4 space-x-2 whitespace-nowrap lg:p-5">
                          <a href="delete.php?src=service-category&&table=category&&id=<?php echo $data['id']?>" class="popup_show btn bg-red-500 w-fit text-white">Delete</a>
                        </td>
                      </tr>
                      <?php }?>
...
<!-- All Popup -->
<!-- Approve service -->
<div data-target="approve_service"
    ...
    id="delete-service-modal" style="z-index: 111; display: none;">
    <div data-target="approve_service"
    ...
    <div class="relative px-4 w-full max-w-md h-full md:h-auto z-50">
        <div class="relative bg-white rounded-2xl shadow-lg">
            <div class="flex justify-end p-2"><button type="button" data-target="approve_service"
                    ...
                    data-modal-toggle="delete-service-modal"> <i class="fa-solid fa-xmark"></i> </button></div>
            <div class="p-6 pt-0 text-center text-5xl text-green-500"> <i class="fa-solid fa-circle-exclamation"></i>
                <h3 class="my-9 text-base font-normal text-gray-500">Want to approve this service?
                </h3>
                <div class="w-full flex justify-between items-center gap-x-2"><a href="#" data-target="approve_service"
                        ...
                        data-modal-toggle="delete-service-modal">No, cancel</a>
...
<!-- Reject service -->
<div data-target="reject_service"
    class="popup_wrapper overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 sm:h-full flex"
    id="delete-service-modal" style="z-index: 111; display: none;">
    <div data-target="reject_service" class="popup_remove w-full h-screen bg-black bg-opacity-50 z-40 fixed inset-0 m-auto">
    </div>
    <div class="relative px-4 w-full max-w-md h-full md:h-auto z-50">
        <div class="relative bg-white rounded-2xl shadow-lg">
            <div class="flex justify-end p-2"><button type="button" data-target="reject_service"
                    class="popup_remove text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-2xl text-sm w-8 h-8 flex items-center justify-center ml-auto"
                    data-modal-toggle="delete-service-modal"> <i class="fa-solid fa-xmark"></i> </button></div>
            <div class="p-6 pt-0 text-center text-5xl text-red-500"> <i class="fa-solid fa-circle-exclamation"></i>
                <h3 class="my-9 text-base font-normal text-gray-500">Want to reject this service?
                </h3>
                <div class="w-full flex justify-between items-center gap-x-2"><a href="#" data-target="reject_service"
                        class="popup_remove text-white bg-red-400 border border-gray-200 font-medium inline-flex items-center rounded-lg text-sm px-3 py-2.5 text-center hover:scale-[1.02] transition-transform"
                        data-modal-toggle="delete-service-modal">No, cancel</a>
