...
if(isset($_GET['action'])){
  ...
  if($action == 'solved'){
    ...
    if($ticket_id){
      ...
      header("location:solved-tickets.php?msg=$msg");      
    }
    ...
    header("location:solved-tickets.php");
  }
}
                ...
                <div class="overflow-auto bg-white">
                  <div style="display:flex;justify-content:space-between">
                    <div style="display:flex">
                      <a style="margin:15px;display:block;text-align:center;padding-top:12px;" class="input" href="solved-tickets.php">Refresh <i  class="fa-solid fa-rotate-right"></i></a>
                    </div>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    if(isset($_GET['src'])){
                      ...
                      $tickets = _query("SELECT * FROM tickets INNER JOIN person ON tickets.pid=person.id INNER JOIN service ON tickets.service_id = service.id
                       WHERE tickets.status='Solved' AND subject !='' AND (
                          person.name='$src'  
                       OR person.phone='$src'
                    ...
                    $tickets =_query("SELECT * FROM tickets WHERE status='Solved' AND subject !='' ORDER BY id DESC LIMIT $offset, $total_records_per_page");
                    $total_records = mysqli_num_rows(_get("tickets","status='Solved' AND subject !='' "));
                    ...
                    ?>
                      <tr class="hover:bg-gray-100">
                        ...
                        <td class="text-center p-4 space-x-2 whitespace-nowrap lg:p-5">
                          ...
                          <a href="solved-tickets.php?action=delete&&ticket_id=<?php echo $data['ticket_id']?>" class="popup_show btn bg-red-500 w-fit text-white">Delete</a>
                        </td>
                      </tr>
                      <?php }?>
