                ...
                <div class="overflow-auto bg-white">
                  <div style="display:flex;justify-content:space-between">
                    <div style="display:flex">
                      ...
                      <a style="margin:15px;display:block;text-align:center;padding-top:12px;" class="input" href="published-posts.php"> <i class="fa-solid fa-rotate-right"></i> Refresh</a>
                  ...
                  if(isset($_POST['submit'])){
                    if(isset($_POST['check_list'])){
                      ...
                      header("location:published-posts.php?msg=$msg");
                    }
                  }
                  ?>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    if(isset($_GET['src'])){
                      $src = trim($_GET['src']);
                      $post = _get("post","status='Publish' AND (title='$src' OR category='$src')");                       

                    }elseif(isset($_GET['sort'])){
                      if($_GET['sort']== 'ASC'){
                        $post =_get("post","status='publish' ORDER BY id ASC");
                      }else{
                    ...
                    ?>
                      <tr class="hover:bg-gray-100">
                        ...
                        <td class="text-center p-4 space-x-2 whitespace-nowrap lg:p-5">
                          <a href="edit-post.php?src=published-posts&&table=post&&id=<?php echo $data['id']?>" class="popup_show btn bg-red-500 w-fit text-white" style="background:#4ade80;">Edit</a>
                          <a href="delete.php?src=published-posts&&table=post&&id=<?php echo $data['id']?>" class="popup_show btn bg-red-500 w-fit text-white">Delete</a>
                          <a target="_blank" href="../post.php?src=published-products&&table=products&&id=<?php echo $data['id']?>" class="popup_show btn bg-red-500 w-fit text-white" style="background:#4ade80;">View</a> 
                        </td>
                      </tr>
                      <?php }?>
